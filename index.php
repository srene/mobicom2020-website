...
SIGMOBILE</a> dedicated to addressing the challenges in the areas
...
program, MobiCom 2020 will include a set of workshops,
research demonstrations, and a poster session that includes
the ACM Student Research Competition.
</p>

<!--<h5><b><a href="workshops.php">Workshop</a> submission deadlines:</b></h5>
<a href="https://meteor.ame.asu.edu/mavrix/">MAVRIX</a>: June 30th, 2019<br/>
<a href="http://mobiqoe.ait.ac.at/internet-qoe-2019/">Internet-QoE</a>: June 21, 2019<br/>
<a href="https://aka.ms/hotedgevideo19">HotEdgeVideo</a>:  July 9, 2019 (11:59PM AoE)<br/>
<a href="https://s32019.blogs.rice.edu/">S3</a>: June 30th, 2019<br/>
<a href="https://sites.google.com/view/smas-2019/">SMAS</a>: June 20th, 2019 <br/>
<a href="https://nss.cs.nctu.edu.tw/wintech2019">WiNTECH</a>: June 21, 2019, 5pm EST<br/>
<a href="https://mmnets.cs.gmu.edu/">mmNets</a>: June 28th, 2019 (11:59 PM EST)<br/>
<a href="http://conferences.ece.unm.edu/chants2019/">CHANTS</a>: June 21, 2019
</li>

<br/><br/>

<h5><b><a href="poster-demo.php">Poster and demo</a> deadlines</b></h5>
...
<h5><b><a href="travelgrant.php">Student travel grant</a> deadlines</b></h5>
<div class="table-responsive">
<table class="table table-striped table-sm">
<tr>
<th>Deadlines</th>
...
<tr>
<td>Travel Grant Application Submission Deadline</td>
<td>July 1, 2019 (23:59 EST) </td>
</tr>
<tr>
<td>Travel Grant Award Notification</td>
<td>July 5, 2019</td>
<tr>
<td>Deadline to Accept/Decline Travel Grant Award</td>
<td>July 8, 2019</td>
</tr>
</table>
</div>

<h5><b><a href="registration.php">Registration</a> deadlines</b></h5>
Early-Bird (Ends Sept 1st)<br/>
Late (Ends Oct 20th)<br/>
On-Site (Begins Oct 21st)<br/><br/>
...
<li><b>January 2020</b> - Submission deadline extended to March 21 for abstracts and March 25 for papers.</li>
</ul>
</div>
...
<li>Embedded and energy-harvesting systems</li>
...
In addition to full research papers as described above, MobiCom also invites submission in the following three categories:<br/><br/>

<b>Challenge Papers</b> <br/>
...
<li>Reject: Rejected papers cannot be resubmitted until 11 months have passed since the last MobiCom deadline they were submitted to. We strongly encourage the authors to consider the feedback they got before submitting the paper to MobiCom 2020.</li>
...
<ul style="text-align:left">
<li>Full papers: Contain no more than twelve (12) single-spaced and numbered pages, including figures, tables, any appendices, and any other material, followed by as many pages as necessary for bibliographic references. Papers whose non-bibliographic content is longer than 12 pages will not be reviewed.</li>
<li>Experience/Verification/Challenge Papers: Contain no more than eight (8) single-spaced and numbered pages, including figures, tables, any appendices, and any other material, followed by as many pages as necessary for bibliographic references. Papers whose non-bibliographic content is longer than eight pages will not be reviewed.</li>
<li>Font size no smaller than 10 points.</li>
<li>Double column format with each column having dimensions 9.25 inches x 3.33 inches, a space of 0.33 inches between the two columns, and with no more than 55 lines of text per column.</li>
<li>Submissions must be in PDF (Portable Document Format) authors should ensure that they are compatible with Adobe Acrobat (English version). Any other formats, including Postscript and MS-Word, will not be accepted.</li>
<li>Fit properly on US letter-sized paper (8.5 inches by 11 inches).</li>
<li>Authors' names must not appear anywhere in the paper or in the PDF file. The PDF file must also not contain any embedded hyperlinks, as these may compromise reviewer anonymity.</li>
<li>Limit the file size to less than 15 MB: contact the PC chairs if you have a file larger than this limit.</li>
</ul>
<br/><br/>
...
<h5><b>Awards</b></h5>
All accepted regular papers will be considered for the <b>Best Paper Awards</b>. We will also have a <b>Best Community Paper Award</b>. Among all accepted papers, the program committee will select one that contributes the most to the broader research community in terms of real data, or new software, hardware or other artifacts.
<br/><br/>
<h5><b>Video Presentation</b></h5>
